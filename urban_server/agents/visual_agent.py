...
visual_chooser_schema = {
    ...
    "description": "Determines whether there is an architectural object (building) or interior design in the photo and, if \
    ...
    "properties": {
        "is_building": {
            "type": "boolean",
            "description": "true if there is an architectural object (building or interior design) in the image; otherwise false",
        },
